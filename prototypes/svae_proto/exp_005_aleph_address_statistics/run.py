...
EXP_NAME = "exp_005_aleph_address_statistics"
...
def run(**kwargs):
    """Notebook entry — no CLI parsing.
        ...
        run(out_dir="./experiments/exp_005_results", upload_only=True, hf_token="hf_...")
    """
...
def main(argv=None):
    ...
    p.add_argument("--out-dir", default="./experiments/exp_005_results")
